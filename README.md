# 407Asyn_Task — 轻量级异步任务调度组件

## 项目简介

一个运行在 **STM32F407ZGTx** (Cortex-M4) 上的裸机 (bare-metal) 轻量级异步任务调度组件，基于**时间轮 (Hashed Wheel Timer)** 算法实现，支持异步延迟任务和周期任务的调度与管理。
...
[B站视频 - STM32F407 时间轮异步任务演示](https://b23.tv/pvSHXt9)
